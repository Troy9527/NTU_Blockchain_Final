...
loghash = process.argv[3] 
logname = process.argv[4]
logorg = process.argv[5]
logdate = process.argv[6]

var encoded_data = contract.methods.FoodLog(logno, loghash, logname, logorg, logdate).encodeABI()
